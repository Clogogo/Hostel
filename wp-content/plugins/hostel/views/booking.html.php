<div class="wrap">
	...
	<div class="wrap wphostel-box postbox">
		<form class='wphostel-form' method="post">
			...
			<div><label><?php _e('Contact name:', 'wphostel')?></label> <input type="text" name="contact_name" value="<?php echo empty($booking->contact_name) ? '' : htmlspecialchars(stripslashes($booking->contact_name))?>"></div>
			...
			<div><label><?php _e('Contact phone:', 'wphostel')?></label> <input type="text" name="contact_phone" value="<?php echo empty($booking->contact_phone) ? '' : htmlspecialchars(stripslashes($booking->contact_phone))?>"></div>
			...
			<?php wp_nonce_field('wphostel_booking');?>
		</form>
	</div>
</div>
