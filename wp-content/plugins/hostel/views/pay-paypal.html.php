...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
	<p align="center">
		...
		<input type="hidden" name="return" value="<?php echo (get_option('wphostel_use_pdt') == 1) ? esc_url(add_query_arg(array('wphostel_pdt' => 1), site_url())) : site_url();?>">
		<?php if(get_option('wphostel_use_pdt') != 1):?><input type="hidden" name="notify_url" value="<?php echo site_url('?wphostel=paypal&bid='.$bid);?>"><?php endif;?>
