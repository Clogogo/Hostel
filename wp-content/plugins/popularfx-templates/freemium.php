...
pagelayer_freemium_shortcode(PAGELAYER_SC_PREFIX.'_wp_menu', array(
		...
		'submenu_style' => [
			'submenu_align' => array(
				...
				'css' => ['{{element}} li > ul a' => 'justify-content:{{val}};'],
			),
			'submenu_position' => [
				'type' => 'radio',
				'label' => __pl('position'),
...
pagelayer_freemium_shortcode(PAGELAYER_SC_PREFIX.'_countdown', array(
		...
		'expired_text' =>[
			...
			'expired_background_color' => array(
				'type' => 'color',
				'label' => __pl('bg_color'),
				'css' => ['{{element}} .pagelayer-countdown-expired' => 'background-color:{{expired_background_color}};'],				
			),
			'expired_style' => array(
				'type' => 'typography',
...
pagelayer_freemium_shortcode(PAGELAYER_SC_PREFIX.'_pricing', array(
		...
		'button_style' => [
			...
			'button_url_target' => array(
				'type' => 'checkbox',
				'label' => __pl('open_link_in_new_window'),
				'addAttr' => ['{{element}} .pagelayer-pricing-features a' => 'target="_blank"'],
				'req' => array(
					'!button_url' => ''
				)
			),
...
pagelayer_add_shortcode(PAGELAYER_SC_PREFIX.'_mega_menu', array(
		'name' => __pl('Mega Menu'),
		'group' => 'other',
		'not_visible' => 1,
		'hide_active' => 1,
		...
		'params' => array(
			'mega_menu_width' => array(
				...
				'screen' => 1,
				'units' => ['px', '%'],
				'css' => ['[pagelayer-mega-menu-id="{{ele_id}}"]' => 'width:{{val}}'],
			),
		)
	)	
);
